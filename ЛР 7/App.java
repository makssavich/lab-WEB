...
public class App implements EntryPoint {
                ...
                public void onResponseReceived(Request request, Response response) {
                    if (response.getStatusCode() == 200) {
                        ...
                        if (jsonArray != null) {
							...
							RootPanel.get("senddolarContainer").addStyleName("border-4 border-green-600 border-double ring-offset-2 ring-4 bg-blue-100 px-2 py-2 rounded-lg text-green width: 50% bg-orange-300 px-2 py-2 rounded-lg text-white ml-4");
	...
	RootPanel.get("weatherContainer").addStyleName("border-4 border-green-600 border-double ring-offset-2 ring-4 ");
...
RootPanel.get("weatherButton").add(weatherButton);
		...
		sendButton.addStyleName("sendButton bg-yellow-300 px-2 py-2 rounded-lg text-white ml-4");
...
RootPanel.get("senddolar").add(senddolar);
		...
		message.selectAll();
RootPanel.get("FormPanel").addStyleName("bg-blue-500 px-2 py-2 rounded-lg width: 100% text-green");



phone.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green border-4 border-green-600 border-double ring-offset-2 ring-4 shadow-2xl ");
name.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green border-4 border-green-600 border-double ring-offset-2 ring-4 shadow-2xl");
email.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green border-4 border-green-600 border-double ring-offset-2 ring-4 shadow-2xl");
message.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green border-4 border-green-600 border-double ring-offset-2 ring-4 shadow-2xl");
RootPanel.get("senddolar").addStyleName("bg-blue-100 px-2 py-2 rounded-lg text-green width: 50% bg-orange-300 ring-offset-2 ring-4 px-2 py-2 border-4 border-green-600 border-double rounded-lg text-white ml-4");
weatherButton.addStyleName("bg-blue-500 px-2 py-2 rounded-lg text-green border-4 border-green-600 border-double ring-offset-2 ring-4");		
...
dialogBox.addStyleName("bg-orange-500 px-2 py-2 rounded-lg text-white");
...
HTML html = new HTML("<nav class='sticky top-0 h-20 bg-[#243c5a] p-5 sm:px-24 xl:px-64'><div class='mx-auto flex justify-between items-center'><a href='#' class='uppercase text-white text-xl xl:text-3xl font-bold whitespace-no-wrap font-Montserrat leading-normal tracking-tighter'>Start Tailwind</a><button class='block md:hidden uppercase inline-flex items-center bg-green-500 px-3 py-2 rounded-lg text-white'>Menu <svg class='h-4 fill-current' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M4 5h16a1 1 0 0 1 0 2H4a1 1 0 1 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2z'/></svg></button><div class='hidden md:block'><a href='' class='px-4 uppercase text-white text-base font-bold whitespace-no-wrap font-Montserrat leading-normal tracking-tighter hover:text-green-500'>Portfolio</a><a href='' class='px-4 uppercase text-white text-base font-bold whitespace-no-wrap font-Montserrat leading-normal tracking-tighter hover:text-green-500'>About</a><a href='' class='px-4 uppercase text-white text-base font-bold whitespace-no-wrap font-Montserrat leading-normal tracking-tighter hover:text-green-500'>Contact</a></div></div></nav>", true);
	...
	RootPanel.get("body").addStyleName("m-0 h-14 bg-gradient-to-r from-green-200 to-green-100 ");
