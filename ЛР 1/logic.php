...
// Перевірка, чи не оголошена вже функція getUserLocation()
...
// Оголошуємо функцію, яка генерує випадкову знижку
function calculateDiscount($price) {
    $discountPercentage = 0;
    $discountPercentage = rand(1, 30); // Випадково визначаємо відсоток знижки в межах від 1% до 30%
