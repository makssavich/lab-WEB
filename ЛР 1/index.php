...
<main>
  ...
  <?php
  $house1 = new House(60000, 'Detached house • 5y old', '742 Evergreen Terrace', '(555) 555-4321', 'https://images.unsplash.com/photo-1475855581690-80accde3ae2b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80', 3, 2, ifDiscount());
$house2 = new House(60000, 'Apartment • 2y old', '123 Oak Street', '(555) 555-6789', 'https://images.unsplash.com/photo-1475855581690-80accde3ae2b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80', 2, 1, ifDiscount());

// Виведення HTML-представлення будинків
echo $house1->renderHTML();
echo $house2->renderHTML();
?>
</div>
  ...
  <section class="bg-gray-800 -mt-12 py-16">
    ...
    // Виклик функції для отримання інформації про локацію користувача
    $userLocation = getUserLocation();

    // Виведення інформації про локацію
