                ...
                public void onResponseReceived(Request request, Response response) {
                    if (response.getStatusCode() == 200) {
                        ...
                        if (jsonArray != null) {
							...
							RootPanel.get("senddolarContainer").addStyleName("bg-blue-100 px-2 py-2 rounded-lg text-green width: 50% bg-orange-300 px-2 py-2 rounded-lg text-white ml-4");
...
phone.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green");
name.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green");
email.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green");
message.addStyleName("bg-orange-100 px-2 py-2 rounded-lg text-green  ");
RootPanel.get("senddolar").addStyleName("bg-blue-100 px-2 py-2 rounded-lg text-green width: 50% bg-orange-300 px-2 py-2 rounded-lg text-white ml-4");
