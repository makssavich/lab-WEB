...
<div class="flex justify-end mt-4 mr-6">
    <?php
    // Визначаємо значення параметра $_GET['houses'] або встановлюємо його за замовчуванням як 3
    $showMore = isset($_GET['houses']) ? $_GET['houses'] + 3 : 3;
    echo "<a href=\"?houses=$showMore\" class=\"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded\">Показати більше</a>";
    echo "Поточне значення змінної \$showMore: $showMore";
    ?>
</div>
